...
module.exports = (env) => {
  ...
  return {
    ...
    // ],
    entry: {
      // entry main should put firstly, because of 
      // https://github.com/callstack/repack/issues/258 and https://github.com/callstack/repack/issues/257
      main: entry, 
      base: [
        ...Repack.getInitializationEntries(reactNativePath, {
              hmr: devServer && devServer.hmr,
    ...
    output: {
      clean: true,
      path: path.join(__dirname, 'build/generated2', platform),
    ...
    plugins: [
      ...
      //   platform
      // }),
      // new Repack.plugins.DevelopmentPlugin({
      //   platform,
      //   devServer,
      // }),
